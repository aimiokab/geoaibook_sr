...
def stretch_standardize_utils(img, type="sen2", nb_channels=4):
...
class SRNormalize(object):
    def __init__(self):
        pass

    def __call__(self, batch): 
        batch['s2-multi'] =  stretch_standardize_utils(batch['s2-multi']/10000, type="s2", nb_channels=4)
        #batch['spot'] =  stretch_standardize_utils(batch['spot']/4095, type="spot", nb_channels=3)
        batch['spot'] =  2*batch['spot']/255.-1
        return batch